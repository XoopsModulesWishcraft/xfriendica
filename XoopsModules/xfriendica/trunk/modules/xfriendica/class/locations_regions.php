 ...
 * Locations_regions: wishcraft - simon@chronolabs.com
 *
 ...
 * This File:	mail.php
 * Description:	Locations_regions Handler and Object Class for Module
 ...
 */
class XFriendicaLocations_regions extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaLocations_regionsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaLocations_regionsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_locations_regions", "XFriendicaLocations_regions", "id", 'name');
    }
