 ...
 * This File:	plugins_protocols.php
 * Description:	Plugins_protocols Handler and Object Class for Module
 ...
 */
class XFriendicaPlugins_protocols extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPlugins_protocolsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPlugins_protocolsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_plugins_protocols", "XFriendicaPlugins_protocols", "id", 'global-guid');
    }
