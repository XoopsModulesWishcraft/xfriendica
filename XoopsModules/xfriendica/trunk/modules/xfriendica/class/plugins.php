 ...
 * This File:	conv.php
 * Description:	Plugins Handler and Object Class for Module
 ...
 */
class XFriendicaPlugins extends XoopsObject
{
    function __construct()
    {
    	
        $this->initVar('id', XOBJ_DTYPE_INT, null, true, 40);
        $this->initVar('state', XOBJ_DTYPE_ENUM, 'adaptors', false, false, false, array('adaptors','connectors','plugins'));
        ...
        $this->initVar('module', XOBJ_DTYPE_TXTBOX, '', false, 128);
        $this->initVar('poll', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('cron', XOBJ_DTYPE_INT, 0, false);
        ...
        $this->initVar('downloaded', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('installed', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('haspreload', XOBJ_DTYPE_INT, 0, false);
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPluginsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPluginsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_plugins", "XFriendicaPlugins", "id", 'domain');
    }
