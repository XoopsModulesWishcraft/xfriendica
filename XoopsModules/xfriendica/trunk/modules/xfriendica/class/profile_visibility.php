...
class XfriendicaProfile_visibility extends XoopsObject
{
    function __construct()
    {
        $this->initVar('field_id', XOBJ_DTYPE_INT);
        $this->initVar('network_group', XOBJ_DTYPE_INT);
        $this->initVar('user_group', XOBJ_DTYPE_INT);
        $this->initVar('profile_group', XOBJ_DTYPE_INT);
    }

    function XfriendicaProfile_visibility()
    {
        $this->__construct();
    }
}

class XfriendicaProfile_visibilityHandler extends XoopsPersistableObjectHandler
{
    function XfriendicaProfile_visibilityHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, 'friendica_profile_visibility', 'XfriendicaProfile_visibility', 'field_id');
       }
