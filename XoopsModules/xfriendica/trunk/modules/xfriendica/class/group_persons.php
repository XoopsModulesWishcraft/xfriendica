 ...
 * This File:	conv.php
 * Description:	Group_persons Handler and Object Class for Module
 ...
 */
class XFriendicaGroup_persons extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaGroup_personsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaGroup_personsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_group_persons", "XFriendicaGroup_persons", "id", 'gcid');
    }
