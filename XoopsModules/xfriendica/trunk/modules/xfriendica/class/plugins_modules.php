 ...
 * This File:	plugins_modules.php
 * Description:	Plugins_modules Handler and Object Class for Module
 ...
 */
class XFriendicaPlugins_modules extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPlugins_modulesHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPlugins_modulesHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_plugins_modules", "XFriendicaPlugins_modules", "id", 'dirname');
    }
