 ...
 * This File:	protocols_resources.php
 * Description:	Protocols_resources Handler and Object Class for Module
 ...
 */
class XFriendicaProtocols_resources extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaProtocols_resourcesHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaProtocols_resourcesHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_protocols_resources", "XFriendicaProtocols_resources", "id", 'name');
    }
