 ...
 *
 */
class XFriendicaCiphersMCryptXtea extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_XTEA;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptXteaStatic extends XFriendicaCiphersMCryptXtea
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
