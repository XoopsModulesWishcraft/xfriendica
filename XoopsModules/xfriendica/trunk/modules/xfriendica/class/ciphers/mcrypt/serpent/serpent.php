 ...
 *
 */
class XFriendicaCiphersMCryptSerpent extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_SERPENT;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptSerpentStatic extends XFriendicaCiphersMCryptSerpent
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
