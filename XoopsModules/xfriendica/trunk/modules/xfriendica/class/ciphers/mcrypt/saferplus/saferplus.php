 ...
 *
 */
class XFriendicaCiphersMCryptSaferplus extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_SAFERPLUS;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptSaferplusStatic extends XFriendicaCiphersMCryptSaferplus
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
