 ...
 *
 */
class XFriendicaCiphersMCryptSkipjack extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_SKIPJACK;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptSkipjackStatic extends XFriendicaCiphersMCryptSkipjack
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
