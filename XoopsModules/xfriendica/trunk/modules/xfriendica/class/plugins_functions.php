 ...
 * This File:	plugins_functions.php
 * Description:	Plugins_functions Handler and Object Class for Module
 ...
 */
class XFriendicaPlugins_functions extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPlugins_functionsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPlugins_functionsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_plugins_functions", "XFriendicaPlugins_functions", "id", 'command');
    }
