 ...
 * This File:	protocols_functions.php
 * Description:	Protocols_functions Handler and Object Class for Module
 ...
 */
class XFriendicaProtocols_functions extends XoopsObject
{
    function __construct()
    {
    	
        $this->initVar('id', XOBJ_DTYPE_INT, null, true);
        $this->initVar('type', XOBJ_DTYPE_ENUM, '', false, false, false, array('main','poll','cron','admin','preload','internal'));
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaProtocols_functionsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaProtocols_functionsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_protocols_functions", "XFriendicaProtocols_functions", "id", 'command');
    }
