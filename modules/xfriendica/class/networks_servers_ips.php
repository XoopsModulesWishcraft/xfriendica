 ...
 * This File:	conv.php
 * Description:	Networks_servers_ips Handler and Object Class for Module
 ...
 */
class XFriendicaNetworks_servers_ips	 extends XoopsObject
{
    function __construct()
    {
        ...
        $this->initVar('listening', XOBJ_DTYPE_ENUM, 'No', false, false, false, array('Yes', 'No'));
        $this->initVar('ignoring', XOBJ_DTYPE_ENUM, 'No', false, false, false, array('Yes', 'No'));
        ...
        $this->initVar('notified', XOBJ_DTYPE_ENUM, 'No', false, false, false, array('Yes', 'No'));
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaNetworks_servers_ipsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaNetworks_servers_ipsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_networks_servers_ips", "XFriendicaNetworks_servers_ips", "id", 'domain');
    }
