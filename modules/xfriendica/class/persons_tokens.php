 ...
 * This File:	conv.php
 * Description:	Persons_tokens Handler and Object Class for Module
 ...
 */
class XFriendicaPersons_tokens extends XoopsObject
{
    function __construct()
    {
    	
        $this->initVar('id', XOBJ_DTYPE_TXTBOX, null, true, 40);
        $this->initVar('request', XOBJ_DTYPE_INT, 0, false);
        ...
        $this->initVar('client-id', XOBJ_DTYPE_INT, 0, false);
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPersons_tokensHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPersons_tokensHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_persons_tokens", "XFriendicaPersons_tokens", "id", 'domain');
    }
