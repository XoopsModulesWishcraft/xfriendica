<?php
// $Id: xoops.crc.enumerator.php 1.1.0 - XOOPSCRC 2008-08-15 9:22:20 wishcraft $
//  ------------------------------------------------------------------------ //
...
if (!class_exists('xoops_crc_enumerator'))
{
	error_reporting(0);
	
	class xoops_crc_enumerator extends xoops_crc
	{
