 ...
 * This File:	conv.php
 * Description:	Photo_albums Handler and Object Class for Module
 ...
 */
class XFriendicaPhoto_albums extends XoopsObject
{
    function __construct()
    {
        ...
        $this->initVar('photos', XOBJ_DTYPE_INT, 0, false);
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPhoto_albumsHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPhoto_albumsHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_photo_albums", "XFriendicaPhoto_albums", "id", 'domain');
    }
