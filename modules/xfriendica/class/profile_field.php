 ...
 */
class XfriendicaProfile_field extends XoopsObject
{
    ...
    function XfriendicaProfile_field()
    {
        $this->__construct();
    }
    ...
    * @param XfriendicaProfile_XfriendicaProfile_ $profile {@link XfriendicaProfile_XfriendicaProfile_} object to edit the value of
    *
    ...
    * @param profileXfriendicaProfile_ $profile object to get the value of
    *
    * @return mixed
    **/
    ...
    */
    ...
    {
        $profile_handler = xoops_getmodulehandler('profile_data', 'friendica');
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XfriendicaProfile_fieldHandler extends XoopsPersistableObjectHandler
{
    function XfriendicaProfile_fieldHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, 'friendica_profile_field', "XfriendicaProfile_field", "field_id", 'field_title');
    }
    ...
    */
    function loadFields($force_update = false)
    {
        ...
        if (!empty($force_update) || count($fields) == 0) {
            ...
            $criteria->setSort('l.weight ASC, o.field_weight');
            $field_objs = $this->getByLink($criteria, array('o.*'), true, 'id', 'id');
    ...
    **/
    ...
    /**
     * Get array of standard variable names (profile table)
     *
     * @return array
     */
    function getProfileVars()
    {
        return array('id', 'fuid', 'guid', 'profile-name', 'is-default','hide-friends', 'name', 'description', 'summary',
        'locality', 'pub_keywords', 'prv_keywords', 'homepage', 'photo-id', 'publish', 'net-publish');
    }
    ...
    function getUserVars()
    {
    	return array('fuid', 'guid', 'uid', 'nickname', 'openid','register-date', 'login-date', 'default-location', 'allow-location',
    			'keys-id', 'skeys-id', 'verified', 'blocked', 'blockwall', 'hidewall', 'blocktags', 'unkmail', 'cntunkmail', 'prvnets',
    			'expire', 'account-removed', 'account-expired', 'account-expires-on', 'expire-notification-sent', 'service-class',
    			'openidserver');
    }
