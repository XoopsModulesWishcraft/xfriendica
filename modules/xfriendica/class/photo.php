 ...
 * This File:	conv.php
 * Description:	Photo Handler and Object Class for Module
 ...
 */
class XFriendicaPhoto extends XoopsObject
{
    function __construct()
    {
    	
        $this->initVar('id', XOBJ_DTYPE_INT, null, true, 40);
        $this->initVar('source', XOBJ_DTYPE_ENUM, 'file', false, false, false, array('file','database'));
        ...
        $this->initVar('resource-id', XOBJ_DTYPE_TXTBOX, '', false, 255);
        $this->initVar('data-id', XOBJ_DTYPE_INT, 0, false);
        ...
        $this->initVar('photo-path', XOBJ_DTYPE_TXTBOX, '', false, 255);
        $this->initVar('thumb-path', XOBJ_DTYPE_TXTBOX, '', false, 255);
        $this->initVar('height', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('width', XOBJ_DTYPE_INT, 0, false);
       	$this->initVar('scale', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('profile', XOBJ_DTYPE_INT, 0, false);
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPhotoHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPhotoHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_photo", "XFriendicaPhoto", "id", 'domain');
    }
