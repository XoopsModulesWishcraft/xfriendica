 ...
 * This File:	conv.php
 * Description:	Queue_tasks Handler and Object Class for Module
 ...
 */
class XFriendicaQueue_tasks extends XoopsObject
{
    function __construct()
    {
        ...
        $this->initVar('batch-id', XOBJ_DTYPE_INT, 0, false);
        ...
        $this->initVar('took', XOBJ_DTYPE_INT, 0, false);
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaQueue_tasksHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaQueue_tasksHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_queue_tasks", "XFriendicaQueue_tasks", "id", 'minimum');
    }
