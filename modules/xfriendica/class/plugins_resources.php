 ...
 * This File:	plugins_resources.php
 * Description:	Plugins_resources Handler and Object Class for Module
 ...
 */
class XFriendicaPlugins_resources extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPlugins_resourcesHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPlugins_resourcesHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_plugins_resources", "XFriendicaPlugins_resources", "id", 'name');
    }
