 ...
 * This File:	item_files.php
 * Description:	Item_files Handler and Object Class for Module
 ...
 */
class XFriendicaItem_files extends XoopsObject
{
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaItem_filesHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaItem_filesHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_item_files", "XFriendicaItem_files", "id", 'value');
    }
