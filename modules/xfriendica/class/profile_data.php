 ...
 */
class XfriendicaProfile_data extends XoopsObject
{
    ...
    function XfriendicaProfile_data($fields)
    {
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XfriendicaProfile_dataHandler extends XoopsPersistableObjectHandler
{
    /**
    ...
    */
    ...
    function XfriendicaProfile_dataHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_profile_data", 'XfriendicaProfile_data', "profile_id");
        $this->_fHandler = xoops_getmodulehandler('profile_field', 'xfriendica');
    }

    /**
     * create a new {@link XfriendicaProfile_data}
     *
     * @param bool $isNew Flag the new objects as "new"?
     *
     * @return object {@link XfriendicaProfile_data}
     */
    ...
    /**
     * Get a {@link XfriendicaProfile_data}
     *
     * @param   boolean $createOnFailure create a new {@link XfriendicaProfile_data} if none is feteched
     *
     * @return  object {@link XfriendicaProfile_data}
     */
