 ...
 * This File:	conv.php
 * Description:	Persons_spam Handler and Object Class for Module
 ...
 */
class XFriendicaPersons_spam extends XoopsObject
{
    function __construct()
    {
        ...
        $this->initVar('ham', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('term-id', XOBJ_DTYPE_INT, 0, false, 255);
 ...
 * @copyright copyright &copy; 2000 XOOPS.org
 */
class XFriendicaPersons_spamHandler extends XoopsPersistableObjectHandler
{
    function XFriendicaPersons_spamHandler(&$db)
    {
        $this->__construct($db);
    }
    ...
    {
        parent::__construct($db, "xfriendica_persons_spam", "XFriendicaPersons_spam", "id", 'domain');
    }
