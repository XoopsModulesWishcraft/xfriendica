 ...
 *
 */
class XFriendicaCiphersMCryptWake extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_WAKE;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptWakeStatic extends XFriendicaCiphersMCryptWake
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
