 ...
 *
 */
class XFriendicaCiphersMCryptTwofish extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_TWOFISH;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptTwofishStatic extends XFriendicaCiphersMCryptTwofish
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
