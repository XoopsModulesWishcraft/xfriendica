 ...
 *
 */
class XFriendicaCiphersMCryptThreeway extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_THREEWAY;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptThreewayStatic extends XFriendicaCiphersMCryptThreeway
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
