 ...
 *
 */
class XFriendicaCiphersMCryptTripledes extends XFriendicaCiphers
{
	/**
	 * function name and class typecast
	 *
	 */
	var $_func = 	MCRYPT_TRIPLEDES;
 ...
 * @abstract
 */
class XFriendicaCiphersMCryptTripledesStatic extends XFriendicaCiphersMCryptTripledes
{
	function __construct($data, $salt, $parent, $mode = 'inhertit') {
